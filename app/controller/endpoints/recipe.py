...
# )
# from app.alchemy_models.user import UserBase
#
# router = APIRouter()
...
#
#
# @router.get("/my-resources/", status_code=200, response_model=RecipeSearchResults)
...
#             headers={"UserBase-agent": "recipe bot 0.1"},
#         )
#
...
#     user: UserBase = Depends(deps.get_current_active_superuser),
# ) -> dict:
