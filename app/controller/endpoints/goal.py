...
from app.models import GoalReadWithResources, User, GoalCreate, GoalResourceCreate, \
    GoalResourceMultiCreate, Role
...
def create_goal(
    ...
    """Create a goal"""
    stu_id, grp_id, std_id = (goal_in.student_id,
                              goal_in.group_id,
                              goal_in.standard_id)
...
def add_resource_link(
    ...
    resources = [r for r in resources if
                 r.creator == current_teacher or not r.private]
